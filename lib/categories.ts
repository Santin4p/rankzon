...
export const sections: Section[] = [
  {
    ...
    categories: [
      ...
      },
      {
        slug: "memorias-ram",
        name: "Memorias RAM",
        description: "Las mejores memorias RAM DDR4 y DDR5 para PC y portátil",
        previewImage: "/images/memorias-ram/timetec-8gb-ddr3l-1600mhz-pc3l-12800-no-ecc-sin.jpg",
      },
      {
        slug: "tiras-led",
        name: "Tiras LED",
        description: "Las mejores tiras LED inteligentes RGB para decoración y gaming",
        previewImage: "/images/tiras-led/hovvida-tira-led-10m.jpg",
      },
      {
        slug: "cables-usb-c",
        name: "Cables USB-C",
        description: "Los mejores cables USB-C para carga rápida y transferencia de datos",
        previewImage: "/images/cables-usb-c/iniu-cable-usb-a-usb-c.jpg",
      },
      {
        slug: "cargadores-inalambricos",
        name: "Cargadores Inalámbricos",
        description: "Los mejores cargadores inalámbricos Qi y MagSafe para móviles",
        previewImage: "/images/cargadores-inalambricos/iniu-cargador-inalambrico-rapido-stand.jpg",
      },
      {
        slug: "powerbanks",
        name: "Powerbanks",
        description: "Las mejores baterías externas portátiles para móviles y portátiles",
        previewImage: "/images/powerbanks/iniu-power-bank.jpg",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        slug: "sillas-gaming",
        name: "Sillas Gaming",
        description: "Las mejores sillas gaming ergonómicas para largas sesiones",
        previewImage: "/images/sillas-gaming/alfordson-silla-gaming-ergonomica-con-masaje.jpg",
      },
    ],
  },
  {
    ...
    categories: [
      ...
      },
      {
        ...
        description: "Los mejores cepillos de dientes eléctricos Oral-B y Philips Sonicare",
        previewImage: "/images/cepillos-dentales-electricos/oral-b-io-series-4.jpg",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        ...
        description: "Las mejores zapatillas de running para asfalto y trail",
        previewImage: "/images/zapatillas-running/adidas-hombre-galaxy-7-zapatillas-de-correr.jpg",
      },
      {
        slug: "relojes-hombre",
        name: "Relojes de Hombre",
        description: "Los mejores relojes para hombre: clásicos, deportivos y smartwatches",
        previewImage: "/images/relojes-hombre/garmin-forerunner-165.jpg",
      },
      {
        slug: "equipamiento-fitness",
        name: "Equipamiento Fitness",
        description: "El mejor equipamiento de fitness para entrenar en casa y en el gym",
        previewImage: "/images/equipamiento-fitness/amazon-basics-par-de-mancuernas-de-neopreno.jpg",
      },
      {
        slug: "mochilas",
        name: "Mochilas",
        description: "Las mejores mochilas para trabajo, senderismo y viaje",
        previewImage: "/images/mochilas/eucomir-mochilas-de-cuerdas.jpg",
      },
    ],
  },
]
