...
export async function generateMetadata({
  ...
  if (!category) return {}
  return {
    title: `Los 10 Mejores ${category.name} de 2026`,
    description: `Ranking actualizado de los 10 mejores ${category.name.toLowerCase()} en Amazon España. Curación manual, sin publicidad de pago.`,
  }
}
